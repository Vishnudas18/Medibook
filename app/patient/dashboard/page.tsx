  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10">
        {[
          { label: 'Upcoming', value: '—', icon: Clock, trend: 'Next appointment', color: 'text-blue-600', bg: 'bg-blue-50' },
          { label: 'This Month', value: '—', icon: CalendarDays, trend: 'Appointments', color: 'text-primary-600', bg: 'bg-primary-50' },
          { label: 'Health Score', value: '—', icon: Activity, trend: 'Coming soon', color: 'text-purple-600', bg: 'bg-purple-50' },
        ].map((stat) => (
